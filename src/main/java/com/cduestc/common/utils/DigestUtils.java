...
public final class DigestUtils extends org.springframework.util.DigestUtils {
    ...
    public static String md5Hex(final String data) {
        return DigestUtils.md5DigestAsHex(data.getBytes(Charset.defaultCharset()));
    }
     ...
     * @return 加密后的字符
     */
    public static String hashByShiro(Object source) {
        return new SimpleHash("md5", source, "test", 2).toHex();
    }
