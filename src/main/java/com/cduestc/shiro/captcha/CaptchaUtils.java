 ...
 * @author admin
 * @description 验证码工具类
 * @date 2017-09-08 22:31
 */
public class CaptchaUtils {
    //默认的验证码大小
    private static final int WIDTH = 108, HEIGHT = 40, CODE_SIZE = 4;
    //验证码随机字符数组
    protected static final char[] charArray = "3456789abcdefhgkmnpqrjstuvwxyABCDEFGHJKMNPQRSTUVWXY".toCharArray();
    //验证码字体
     ...
     * 生成验证码
     */
    public static void generate(HttpServletResponse response, String captchaCode) {
