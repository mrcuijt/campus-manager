...
<div class="container">
    ...
    >
        ...
        <tr>
            ...
            <th data-align="left" data-field="phone">用户手机号</th>
            ...
            <th data-align="left" data-field="receiverPhone"
                data-sortable="true">待收货人</th>
            <th data-align="left" data-field="adminPhone"
                data-sortable="true">配送人手机号</th>
        </tr>
        </thead>
    </table>
</div>
...
<script>
    $(function(){
        ...
        $("#table").bootstrapTable({
            url:"order/getPCSimpleOrder?server=56846a8a2fee49d14901d39cc48b8b2a&status=2&campusId="+campusId
        });
    });
</script>
</html>
